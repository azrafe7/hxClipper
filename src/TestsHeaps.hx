...
using StringTools;
using TestsHeaps.InternalTools;

typedef Clipper = hxd.clipper.Clipper;
typedef CInt = Int;
typedef Paths = IPolygons;
typedef Path = IPolygon;
typedef PolyTree = hxd.clipper.PolyTree; // private
typedef IntPoint = IPoint;

/*
 * NOTES hxClipper -> Heaps Clipper:
 * 
 *   - adjust Enum values
...
* @author azrafe7
*/
class TestsHeaps extends TestCase
{
  var subj:Paths;
  var clip:Paths;
  var solution:Paths;
  ...
  function testDifference1():Void 
  {
    ...
    var c = new Clipper();
    c.addPolygons(subj, Subject/*, true*/);
    c.addPolygons(clip, Clip/*, true*/);
    solution = c.execute(ClipType.Difference, pft, pft);
    var res = solution.length > 0;
  ...
  function testHorz1():Void {
    ...
    c.addPolygons(subj, Subject/*, true*/);
    c.addPolygons(clip, Clip/*, true*/);
    solution = c.execute(ClipType.Intersection, pft, pft);
    var res = solution.length > 0;
  ...
  function testHorz4():Void {
    ...
    var c = new Clipper();
    c.addPolygons(subj, Subject/*, true*/);
    solution = c.execute(ClipType.Union, pft, pft);
    var res = solution.length > 0;
  ...
  function testHorz5():Void {
    ...
    c.addPolygons(subj, Subject/*, true*/);
    c.addPolygons(clip, Clip/*, true*/);
    solution = c.execute(Difference, pft, pft);
    var res = solution.length > 0;
  ...
  function testHorz6():Void {
    ...
    c.addPolygons(subj, Subject/*, true*/);
    c.addPolygons(clip, Clip/*, true*/);
    solution = c.execute(Intersection, pft, pft);
    var res = solution.length > 0;
  ...
  function testOrientation5():Void {
    ...
    solution = c.execute(Union, pft, pft);
    var res = solution.length > 0;
  ...
  function testaddPolygon10():Void {
  ...
  function testaddPolygon11():Void {
  ...
  function testaddPolygon12():Void {
  ...
  function testaddPolygon13():Void {
  ...
  function testaddPolygon14():Void {
  ...
  function testaddPolygon15():Void {
  ...
  function testaddPolygon16():Void {
  ...
  function testaddPolygon17():Void {
  ...
  function testaddPolygon18():Void {
  ...
  function testaddPolygon19():Void {
  ...
  function testaddPolygon20():Void {
  ...
  function testOpenPath1():Void {
    ...
    var c = new Clipper();
    c.addPolygons(subj, Subject/*, false*/);
    c.addPolygons(clip, Clip/*, true*/);
    var res = c.ExecuteTree(Intersection, polytree, pft, pft);
    assertTrue(res);
  }
  //---------------------------------------------------------------------------
  ...
  function testOpenPath4():Void {
    ...
    c.addPolygons(subj, Subject/*, false*/);
    c.addPolygons(clip, Clip/*, true*/);
    var res = c.ExecuteTree(Intersection, polytree, pft, pft) && (polytree.childCount == 1);
    assertTrue(res);
  }
  //---------------------------------------------------------------------------
  ...
  function testOffsetPoly1():Void {
    ...
    co.addPolygons(subj, Round, ClosedPol);
    solution.clear();
    solution = co.execute(-7.0 * scale);
    assertEquals(2, solution.length);
  }
  //---------------------------------------------------------------------------
  ...
  static public function run():Void 
  {
    ...
    runner.add(new TestsHeaps());
    var startTime = Timer.stamp();
    var success = runner.run();
    trace("TestsHeaps executed in " + (Timer.stamp() - startTime) + "s");
  }
}
